...
} from './blood-pressure.page-object';
...
describe('BloodPressure e2e test', () => {
  ...
  /*  it('should create and save BloodPressures', async () => {
        ...
        expect(await bloodPressureUpdatePage.getTimestampInput()).to.contain('2001-01-01T02:30', 'Expected timestamp value to be equals to 2000-12-31');
  ...
  /*  it('should delete last BloodPressure', async () => {
        ...
        expect(await bloodPressureDeleteDialog.getDialogTitle())
            .to.eq('twentyOnePointsApp.bloodPressure.delete.question');
