...
import {
  WeightComponentsPage,
  /* WeightDeleteDialog,
   */ WeightUpdatePage
} from './weight.page-object';
...
describe('Weight e2e test', () => {
  ...
  /*  it('should create and save Weights', async () => {
        ...
        expect(await weightUpdatePage.getTimestampInput()).to.contain('2001-01-01T02:30', 'Expected timestamp value to be equals to 2000-12-31');
  ...
  /*  it('should delete last Weight', async () => {
        ...
        expect(await weightDeleteDialog.getDialogTitle())
            .to.eq('twentyOnePointsApp.weight.delete.question');
