...
describe('Point e2e test', () => {
  ...
  /*  it('should create and save Points', async () => {
        ...
        await promise.all([
            ...
            pointUpdatePage.setNoteInput('note'),
        ...
        expect(await pointUpdatePage.getNoteInput()).to.eq('note', 'Expected Note value to be equals to note');
  ...
  /*  it('should delete last Point', async () => {
        ...
        expect(await pointDeleteDialog.getDialogTitle())
            .to.eq('twentyOnePointsApp.point.delete.question');
